...
class QuoteLookup
{
     ...
     */
    public function findAll(int $page, int $limit, int $offset, $search = '', $tags = null, $attributions = null, $creatorIDs=[], $status=[])
    {
        ...
        $quoteCollectionMapper->fetch($quoteCollection, $search, $tags, $attributions, $limit, $offset);
