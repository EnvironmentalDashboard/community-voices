    ...
    <xsl:template match="/form">
        ...
        <div class="row">
          <div class="col-sm-3">
            ...
            <form class="p-2" action="" method="GET" id="filter-images" style="display:none">
              <h4>Filter images</h4>
              <div class="form-group">
          ...
          <div class="col-sm-9">
            <div><div id="ajax-quotes" style="min-height:400px">
              <h2 class="mb-2">Select a quote</h2>
              <p><a id="prev-quote" href="" class="btn btn-sm btn-outline-primary">&#8592; Previous page</a> <a id="next-quote" href="" class="btn btn-sm btn-outline-primary float-right">Next page &#8594;</a></p>
            ...
            <div><div style="display:none;min-height:400px" id="ajax-images">
              ...
              <p><a id="prev-image" href="" class="btn btn-sm btn-outline-primary">&#8592; Previous page</a> <a id="next-image" href="" class="btn btn-sm btn-outline-primary float-right">Next page &#8594;</a></p>
              <div class="selectables"></div>
            </div></div>
