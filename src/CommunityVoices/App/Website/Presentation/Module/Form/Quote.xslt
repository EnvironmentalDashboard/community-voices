            ...
            <div class="col-12">
                <form method='POST' style="max-width:400px;margin: 0 auto" id="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type='text' name='attribution' id='attribution' class='form-control' maxlength='25' onkeyup="displayCount(this,'countAttribution')">
                            <xsl:attribute name="value">
                                    <xsl:choose>
                                    <xsl:when test="domain/form != ''">
                    ...
                    <div class="form-group">
                        ...
                        <input type='text' name='subAttribution' id='subAttribution' class='form-control' maxlength='25' onkeyUp="displayCount(this,'countSubAttribution')">
                            <xsl:attribute name="value">
                                <xsl:choose>
                                    <xsl:when test="domain/form != ''">
