...
) ENGINE=InnoDB AUTO_INCREMENT=16950 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `community-voices_media-location-map` (
  ...
  KEY `loc_id` (`loc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=42045 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-09-21 11:57:46
